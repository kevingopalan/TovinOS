...
var COLORS = {
  ...
  TREE: '#005108',
  FOG:  '#333333',
  LIGHT:  { road: '#333333', grass: '#105510', rumble: '#555555', lane: '#CCCCCC'  },
  DARK:   { road: '#343434', grass: '#003300', rumble: '#BBBBBB'                   },
  START:  { road: 'white',   grass: 'green',   rumble: 'white'                     },
  FINISH: { road: 'red',   grass: 'black',   rumble: 'red'                     }
};
