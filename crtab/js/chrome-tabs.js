const nl = document.querySelectorAll("iframe");
const nl2 = document.querySelectorAll(".chrome-tab");
function numie() {
  for (let i = 0; i < nl2.length; i++) {
    nl2[i].id = i + "f";
  }
...
((window, factory) => {
    ...
    class ChromeTabs {
      ...
      removeTab(tabEl) {
        ...
        var frm = document.getElementById(tabEl.id + "f")[1];
        frm.remove();
