...
<a onclick = "showWindow(11, 'settings-new.php')"><img src="img/wow64/64x64/apps/preferences-desktop.svg" height="48px" width="48px" id = "tos.app.nano-x1.lost01" style = "display: none;"/></a>
